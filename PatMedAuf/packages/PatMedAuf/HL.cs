...
namespace PatMedAuf
{
    public partial class HL : Form
    {
        ...
        private XDocument BuildHl7V3Document(DataRow p)
        {
            ...
            string geschlecht = GetStr(p, "Geschlecht");       // optional
            ...
            // HL7 v3 / CDA-ähnliches ClinicalDocument (vereinfacht)
            var doc = new XDocument(
                ...
                new XElement(NS + "ClinicalDocument",
                    ...
                    new XElement(NS + "id",
                        new XAttribute("root", "1.2.40.0.10.1.4.1"), // Beispiel OID
                    ...
                    new XElement(NS + "recordTarget",
                        new XElement(NS + "patientRole",
                            new XElement(NS + "id",
                                new XAttribute("root", "1.2.40.0.10.1.4.2"), // Beispiel OID für SVNr
                    ...
                    // Body (Termin-Infos als Section, vereinfacht)
        ...
        private Hl7Patient ParseHl7V3(XDocument doc)
        {
            ...
            // telecom (kann mehrfach vorkommen)
            string tel = "";
            string email = "";
            ...
            // Termin Text (wir haben es als Freitext geschrieben)
...
VALUES
(@SVNr, @Vorname, @Nachname, @Geburtsdatum, @Geschlecht, @Email, @Telefonnummer, @Strasse, @PLZ, @Ort,
 @Termin_Datum, @Termin_Uhrzeit, @Grund, @Dringlichkeit)
...
";
                ...
                using (var cmd = new MySqlCommand(sql, con))
                {
                    ...
                    cmd.Parameters.AddWithValue("@Grund", string.IsNullOrWhiteSpace(p.Grund) ? (object)DBNull.Value : p.Grund);
