    ...
    public partial class Termin : Form
    {
        ...
        private void LoadFromDb(string svnr)
        {
            try
            {
                ...
                // Termin-Felder explizit korrekt setzen (wenn DB-Spalten vorhanden):
...
";
                    ...
                    using (var cmd = new MySqlCommand(sql, con))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@Versicherung", NullIfEmpty(cmbVersicherung.Text));
                        cmd.Parameters.AddWithValue("@Zusatz", NullIfEmpty(cmbZusatz.Text));
                        cmd.Parameters.AddWithValue("@Dringlichkeit", NullIfEmpty(cmbDringlichkeit.Text));

                        cmd.Parameters.AddWithValue("@Mit", ckbMitJa.Checked ? 1 : 0);
                        ...
                        cmd.Parameters.AddWithValue("@NameA", NullIfEmpty(txtNameA.Text));
                        ...
                        cmd.Parameters.AddWithValue("@Grund", NullIfEmpty(txtGrund.Text));

                        cmd.Parameters.AddWithValue("@Email", ckbEmail.Checked ? 1 : 0);
                        cmd.Parameters.AddWithValue("@SMS", ckbSMS.Checked ? 1 : 0);
