...
(
  ...
  Koerper, Gewicht,
  Allergien, AllergienWelche, Medikamente, MedikamenteWelche, Vorerkrankung, VorerkrankungWelche,
...
SET
  ...
  Allergien=@Allergien, AllergienWelche=@AllergienWelche,
  Medikamente=@Medikamente, MedikamenteWelche=@MedikamenteWelche,
  Vorerkrankung=@Vorerkrankung, VorerkrankungWelche=@VorerkrankungWelche,
...
";
        ...
        private void AddCommonParameters(MySqlCommand cmd)
        {
            ...
            cmd.Parameters.AddWithValue("@AllergienWelche", ckbAllergienJa.Checked ? NullIfEmpty(txtAllergien.Text) : DBNull.Value);

            cmd.Parameters.AddWithValue("@Medikamente", ckbMedikamenteJa.Checked ? 1 : 0);
            cmd.Parameters.AddWithValue("@MedikamenteWelche", ckbMedikamenteJa.Checked ? NullIfEmpty(txtMedikamente.Text) : DBNull.Value);

            cmd.Parameters.AddWithValue("@Vorerkrankung", ckbVorerkrankungJa.Checked ? 1 : 0);
            cmd.Parameters.AddWithValue("@VorerkrankungWelche", ckbVorerkrankungJa.Checked ? NullIfEmpty(txtVorerkrankung.Text) : DBNull.Value);
